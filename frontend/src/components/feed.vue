                        ...
                        <div class="card">
                            ...
                            <div class="post-title d-flex align-items-center">
                                ...
                                <div class="profile-thumb">
                                    <a href="#">
                                        <figure class="profile-thumb-middle">
                                            <img src="../../public/images/AvatarMaker (2).png" alt="profile picture">
                                        </figure>
                                    </a>
                                </div>
                                <!-- profile picture end -->
                                ...
                                <div class="post-settings-bar">
                                    ...
                                    <div class="post-settings arrow-shape">
                                        <ul>
                                            <li><button>Modifier son post</button></li>
                        ...
                        <div class="card">
                            ...
                            <div class="post-title d-flex align-items-center">
                                ...
                                <div class="profile-thumb">
                                    <a href="#">
                                        <figure class="profile-thumb-middle">
                                            <img src="../../public/images/AvatarMaker (4).png" alt="profile picture">
                                        </figure>
                                    </a>
                                </div>
                                <!-- profile picture end -->
